...
description: "Use PyInstaller and the build system to produce one-click Node Agent installers for Windows (NSIS), macOS (.pkg), and Linux (systemd) — including service registration and sleep prevention."
---
...
| `build/config.template.yaml` | Config template written by installers; contains `ACTIVATION_CODE_PLACEHOLDER` |
