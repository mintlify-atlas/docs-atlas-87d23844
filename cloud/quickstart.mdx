---
title: "Cloud Server Quickstart: Run the Telescope Net API"
sidebarTitle: "Quickstart"
description: "Get the cloud server running locally: install dependencies, set AAVSO credentials, launch on port 8800, and confirm the health endpoint responds."
---
