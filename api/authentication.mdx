---
title: "API Authentication: Node Keys, Bearer Tokens, Admin Key"
sidebarTitle: "Authentication"
description: "Three auth schemes for The Telescope Net API: node X-Node-Id/X-Api-Key pairs, member Authorization Bearer tokens, and the X-Admin-Key shared secret."
---
