---
title: "Node Agent config.yaml: Complete Configuration Reference"
sidebarTitle: "Configuration"
description: "Node Agent config.yaml reference: cloud, observatory, photometry, AAVSO, safety, ALPACA, devices, logging, and all hardware section defaults explained."
---
